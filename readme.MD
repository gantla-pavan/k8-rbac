...
```
eksctl create iamserviceaccount --cluster roboshop-dev --name secret-reader --namespace roboshop --attach-policy-arn arn:aws:iam::515497299016:policy/RoboShopMYSQLSecretReader --approve
```
